            ...
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="registration.php">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="email" name="email" placeholder="@xyz.com" required>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="p-t-15">
                            <input class="btn btn--radius-2 btn--blue" type="submit" name="sub" value="Submit">
                        </div><br><center>
                        <div class="goback">
                            <a href="../login/index.php"><button type="button" class="btn btn-success">Go Back</button></a>
                        </div></center>
                    </form>
                </div>
            </div>
