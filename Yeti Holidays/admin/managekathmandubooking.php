...
function deletes(bookingid)
{
	a=confirm('Are You Sure To Remove This Record ?')
	 if(a)
     {
        window.location.href='delete.php?bookingid='+bookingid;
     }
}</script>
     <script type="text/javascript">
function deletesvehicle(vehicleno)
{
	a=confirm('Are You Sure To Remove This record ?')
	 if(a)
     {
        window.location.href='deletevehicle.php?vehicleno='+vehicleno;
     }
}
     </script>	
...
<div class="echo">
    ...
    <li><a href="../logout.php">LOGOUT</a></li>
     ...
     <div class="ktm">
         <h4>Kathmandu Booking!</h4></div></div>
     <center>
    ...
    { 
        $sql = "SELECT * FROM  kathmandubooking";
        ...
        if ($result-> num_rows > 0)
        {
            while($row = $result-> fetch_assoc())
            {
                ...
                echo "<td><a href='#' onclick='deletes($row[bookingid])'><span class='glyphicon glyphicon-remove' style=color:red;></span></a></td>";    
            }
            echo "</table>";
        }
        else {
